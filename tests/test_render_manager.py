...
class TestRenderDatabase(unittest.TestCase):
    ...
    def test_all_clients_are_valid(self):
        ...
        for client in clients_from_db:
            self.assertIn(client, clients_from_config)
    ...
    def test_get_available_clients(self):
        ...
        available_clients = render_manager.get_available_clients(self.database_path)
        self.assertEqual(compare_to, available_clients)

    def test_get_status(self):
        '''Test that the status of a single client is valid'''
        self.assertIn(render_manager.get_status(self.database_path, 2), self.valid_status)
    ...
    def test_disable(self):
        ...
        self.assertEqual(render_manager.get_status(self.database_path, 2), "Disabled")

    def test_enable(self):
        '''Test that a row is enabled'''
        render_manager.enable(self.database_path, 5)
        self.assertEqual(render_manager.get_status(self.database_path, 5), "Available")

    def test_busy(self):
        '''Test that a row is rendering'''
        render_manager.busy(self.database_path, 8)
        self.assertEqual(render_manager.get_status(self.database_path, 8), "Rendering")
    ...
    def test_set_host(self):
        ...
        self.assertEqual(render_manager.get_host(self.database_path, 2), "FXTD-001")
    ...
    def test_set_ifd(self):
        ...
        self.assertEqual(render_manager.get_ifd(self.database_path, 4), ifd_path)
    ...
    def test_set_start_time(self):
        ...
        self.assertEqual(render_manager.get_start_time(self.database_path, 10), "5.0")
    ...
    def test_clean(self):
        ...
        render_manager.set_ifd(self.database_path, client_id, "/lbs/staff/hip/test.ifd")
        ...
        self.assertEqual(render_manager.get_row(self.database_path, client_id)[2:],
                         self.default_id[2:])
